...
describe(`Using the object contains matcher`, (): void => {
    ...
    describe(`on two empty objects`, () => {
        ...
        - (test case id: c2a78b59-3302-4af7-88e1-994be26fef72)`, () => {
            const expected = {};
            const actual = {};
            expect(Expected.toContain(expected)(actual)).toBeTruthy()
        });
    ...
    describe(`on two equal objects`, () => {
        ...
        - (test case id: 893aa843-2fb4-41ba-8bfd-c7ab25cfc00b)`, () => {
            const expected = {version: `a`};
            const actual = {version: `a`};
            expect(Expected.toContain(JSON.stringify(expected))(actual)).toBeTruthy()
        });
        ...
        - (test case id: b5c5a571-8022-4d31-bb3f-17663bc2b750)`, () => {
            const expected = {version: `a`};
            const actual = {version: `a`};
            expect(Expected.toContain(expected)(JSON.stringify(actual))).toBeTruthy()
        });
        ...
        - (test case id: 91458b2b-1bba-4120-9bad-51599793d75d)`, () => {
            const expected = {version: `a`};
            const actual = {version: `a`};
            expect(Expected.toContain(JSON.stringify(expected))(JSON.stringify(actual))).toBeTruthy()
        });
    });

    describe(`on two different objects`, () => {

        it(`and both are of type object and actual contains expected, it should return true
        ...
        it(`and both are of type object and actual does not contain expected, it should throw an error
...
\t}
        ...
        it(`and actual is a stringifyed object and actual does not contain expected, it should throw an error
