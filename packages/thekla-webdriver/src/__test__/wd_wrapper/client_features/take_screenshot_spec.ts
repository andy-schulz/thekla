...
describe(`Taking a screenshot`, (): void => {
    ...
    const capabilities: DesiredCapabilities = getStandardTheklaDesiredCapabilities(`take_screenshot_spec.ts - browser1`);
    ...
    describe(`from multiple browser as base64 string`, (): void => {
        ...
        const capabilities2 = getStandardTheklaDesiredCapabilities(`take_screenshot_spec.ts - browser2`);
    ...
    describe(`from multiple browser and save it to a file`, (): void => {
        ...
        const capabilities3 = getStandardTheklaDesiredCapabilities(`take_screenshot_spec.ts - browser3`);
