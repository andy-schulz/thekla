...
import {Browser, ClientHelper, BrowserScreenshotData, RunningBrowser}        from "../../..";
...
describe(`Resize a screenshot`, (): void => {
    ...
    describe(`from a single browser as base64 string`, (): void => {
        it(`should return a 5x5 png` +
            ...
            const imageBinary = Buffer.from(bsd5Browser.browserScreenshotData, `base64`);
    ...
    describe(`from multiple browser as base64 string`, (): void => {
        ...
        const capabilities2 = getStandardTheklaDesiredCapabilities(`resize_screenshot_spec.ts - browser2`);
        ...
        it(`should return two resized images from ClientHelper` +
            ...
            const imageBinary0 = Buffer.from(imagesBase64[0].browserScreenshotData, `base64`);
            const imageBinary1 = Buffer.from(imagesBase64[1].browserScreenshotData, `base64`);
