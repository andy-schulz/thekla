...
import {clientRect}                                                          from "@thekla/support";
...
describe(`Using the browser object`, (): void => {
    ...
    const selConfig: ServerConfig = getStandardTheklaServerConfig();
    const capabilities: DesiredCapabilities = getStandardTheklaDesiredCapabilities(`driver_functions_spec.ts`);
